A new invoice  <a href="{{$data['invoice_url']}}"> <b> {{$data['invoice']->invoice->invoice_no}} </b></a> is generated by {{$data['invoice']->invoice->updatedBy->name }} ({{$data['invoice']->invoice->updatedBy->email}}). Please see the details below or Click <a href="{{$data['invoice_url']}}"> <b> Here </b></a> to see the invoice.
<br/>
<br/>
